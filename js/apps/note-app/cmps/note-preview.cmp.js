...
<div class="pin-contaner">
        ...
        <component :is="cmp.type" :cmp="cmp"  @check="check" @removeTodo="removeTodo" @pin="pin"></component>  
        </div>
        </div>
   <h1>pin</h1> <hr><hr>
<section v-if="notes" class="note-preview flex wrap evenly" >
  <div v-for="cmp in notes" class="note-card" :style="{backgroundColor:cmp.info.color}">
      <component :is="cmp.type" :cmp="cmp" @check="check" @pin="pin" @removeTodo="removeTodo" ></component>        
          <div class="action flex space">      
              ...
              <img src="/imge/003-cancel.png" @click="remove(cmp.id)" class="cancel poinetr" >
